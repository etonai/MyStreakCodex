...
- **Files Modified:**
  - Updated `app/src/main/java/com/pseddev/mystreak/ui/addactivity/AddActivityViewModel.kt` - Added 30, 61, 91 to milestone detection list
  - Updated `app/src/main/java/com/pseddev/mystreak/ui/progress/QuickAddActivityViewModel.kt` - Added 30, 61, 91 to milestone detection list
  - Updated `app/src/main/java/com/pseddev/mystreak/analytics/AnalyticsManager.kt` - Added new emoji levels for extended milestones
  - Updated `app/src/main/java/com/pseddev/mystreak/ui/progress/DashboardFragment.kt` - Updated user-facing emoji display logic
