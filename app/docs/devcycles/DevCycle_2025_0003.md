...
**Files to Modify:**
- `app/src/main/java/com/pseddev/mystreak/utils/CsvHandler.kt` (logging optimization)
- `app/src/main/java/com/pseddev/mystreak/ui/progress/DashboardViewModel.kt` (query optimization)
- `app/src/main/java/com/pseddev/mystreak/data/AppDatabase.kt` (add indices)
- `app/src/main/java/com/pseddev/mystreak/ui/progress/TimelineAdapter.kt` (RecyclerView optimization)
