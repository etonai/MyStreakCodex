...
- `/app/src/main/java/com/pseddev/mystreak/PlayStreakApplication.kt` - Firebase initialization
- `/app/src/main/java/com/pseddev/mystreak/analytics/AnalyticsManager.kt` - Centralized analytics + force sync method
- `/app/src/main/java/com/pseddev/mystreak/crashlytics/CrashlyticsManager.kt` - Centralized crash reporting (NEW)
- `/app/src/main/java/com/pseddev/mystreak/ui/addactivity/AddActivityViewModel.kt` - Analytics and crash reporting
- `/app/src/main/java/com/pseddev/mystreak/ui/importexport/ImportExportViewModel.kt` - Crash reporting for CSV operations
- `/app/src/main/java/com/pseddev/mystreak/ui/main/MainFragment.kt` - Test buttons for Firebase verification
...
- **Files Modified:** `app/src/main/java/com/pseddev/mystreak/ui/progress/QuickAddActivityDialogFragment.kt`
