...
- `app/src/main/java/com/pseddev/mystreak/data/repository/PianoRepository.kt` (add statistics query methods)
...
- `app/src/main/java/com/pseddev/mystreak/ui/progress/TimelineFragment.kt` (comment out methods)
- `app/src/main/java/com/pseddev/mystreak/ui/progress/TimelineViewModel.kt` (comment out data loading)
- `app/src/main/java/com/pseddev/mystreak/data/repository/PianoRepository.kt` (comment out Timeline queries)
...
- `app/src/main/java/com/pseddev/mystreak/ui/progress/SuggestionsViewModel.kt` (favorite limit logic)
- `app/src/main/java/com/pseddev/mystreak/utils/ProUserManager.kt` (Pro status detection)
- Dashboard fragment/ViewModel (location TBD - needs discovery for suggestion logic)
- `app/src/main/java/com/pseddev/mystreak/ui/progress/SuggestionsFragment.kt` (display logic)
