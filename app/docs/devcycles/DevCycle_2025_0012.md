...
- Enable debug mode: `adb shell setprop debug.firebase.analytics.app com.pseddev.mystreak`
...
**Notes:**
- **Key Learning:** Firebase debug mode requires exact package name match (`com.pseddev.mystreak.debug` vs `com.pseddev.mystreak`)
